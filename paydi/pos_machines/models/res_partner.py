...
class ResPartner(models.Model):
    ...
    stock_picking_ids_return = fields.One2many('stock.picking', compute='_get_stock_picking_ids_return', domain=[('|', '|',('return_picking_id', '!=',False), ('out_picking_id', '=', False), '|' ,( 'state', '!=', 'done'), ('show_booking','=', False))])
